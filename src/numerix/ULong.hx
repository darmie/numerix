...
@:abstract
class ULong extends java.lang.Number {
	/**
	 * Generated UID
	 */
	...
	@:overload override public function longValue():I64 {
		return this.value;
	}

	@:overload override public function doubleValue() {
		if (value < 0)
			return untyped __java__('((double) ({0} & Long.MAX_VALUE)) + Long.MAX_VALUE', this.value);
		else
			return return untyped __java__('{0}', this.value);
	}

	@:overload override function floatValue():Single {
		return return untyped __java__('((float) ({0} & Long.MAX_VALUE)) + Long.MAX_VALUE', this.value);
	}

	@:overload override function byteValue():Int8 {
		return untyped __java__('(byte){0}', this.intValue());
	}

	@:overload override function shortValue():Int16 {
		return untyped __java__('(short){0}', this.intValue());
	}
